...
const SEGMENT_PROFILES: Record<number, SegmentProfile> = {
  1: {
    ...
    Q0b: [2.8, 0.9], Q1: [2.8, 1.0], Q2: [2.3, 0.9],
    Q3: ["Home office / remote workspace", "Home office / remote workspace", "Home office / remote workspace", "General storage / premium speed shed", "General storage / premium speed shed", "Creative studio (music, podcast, art)"],
    Q5_cost: [3.5, 0.9], Q5_hoa: [3.2, 1.0], Q5_permit: [2.8, 0.9],
    Q5_space: [2.2, 0.8], Q5_financing: [2.0, 0.7], Q5_quality: [2.4, 0.8], Q5_resale: [2.6, 0.9],
    Q6: ["The total cost (~$23,000)", "The total cost (~$23,000)", "The total cost (~$23,000)", "The total cost (~$23,000)", "HOA restrictions or community rules", "Uncertainty about whether a building permit is required"],
    Q7: [3.4, 0.8],
    Q9a: [3.8, 0.7], Q9b: [3.2, 0.8],
    Q10a: [2.4, 0.9], Q10b: [2.0, 0.8],
    Q11a: [2.6, 0.8], Q11b: [2.2, 0.9],
    Q12a: [1.8, 0.7], Q12b: [1.5, 0.6],
    Q13a: [3.2, 0.8], Q13b: [2.8, 0.9],
    Q14: ["Concept 1: Backyard Home Office", "Concept 1: Backyard Home Office", "None of the above", "None of the above", "Concept 5: Simplicity", "Concept 5: Simplicity"],
  ...
  2: {
    ...
    Q0b: [2.4, 1.0], Q1: [2.2, 0.9], Q2: [1.8, 0.8],
    Q3: ["General storage / premium speed shed", "General storage / premium speed shed", "Adventure basecamp (gear storage, bike workshop, hangout space)", "Adventure basecamp (gear storage, bike workshop, hangout space)", "Adventure basecamp (gear storage, bike workshop, hangout space)", "Creative studio (music, podcast, art)"],
    Q5_cost: [3.8, 0.8], Q5_hoa: [2.2, 0.9], Q5_permit: [2.0, 0.8],
    Q5_space: [2.8, 0.9], Q5_financing: [3.5, 0.8], Q5_quality: [2.4, 0.8], Q5_resale: [2.2, 0.9],
    Q6: ["The total cost (~$23,000)", "The total cost (~$23,000)", "The total cost (~$23,000)", "The total cost (~$23,000)", "Lack of financing options", "Limited backyard space or access"],
    Q7: [3.6, 0.8],
    ...
    Q13a: [3.2, 0.8], Q13b: [2.8, 0.9],
    Q14: ["None of the above", "None of the above", "Concept 4: Adventure Lifestyle / Community", "Concept 4: Adventure Lifestyle / Community", "Concept 4: Adventure Lifestyle / Community", "Concept 3: Wellness / Studio Space"],
  ...
  3: {
    Q0a: ["Yes, I have thought about it but not researched it", "I'm aware it's possible but haven't seriously considered it"],
    Q0b: [2.6, 0.9], Q1: [2.5, 0.9], Q2: [2.1, 0.8],
    Q3: ["Wellness studio (gym, yoga, meditation)", "Wellness studio (gym, yoga, meditation)", "Wellness studio (gym, yoga, meditation)", "General storage / premium speed shed", "Creative studio (music, podcast, art)", "Home office / remote workspace"],
    Q5_cost: [3.4, 0.8], Q5_hoa: [3.0, 0.9], Q5_permit: [2.6, 0.8],
    Q5_space: [2.5, 0.8], Q5_financing: [2.8, 0.8], Q5_quality: [2.8, 0.8], Q5_resale: [2.5, 0.8],
    Q6: ["The total cost (~$23,000)", "The total cost (~$23,000)", "The total cost (~$23,000)", "HOA restrictions or community rules", "Concerns about build quality or durability", "None — I have no significant concerns"],
    Q7: [3.8, 0.7],
    ...
    Q14: ["Concept 3: Wellness / Studio Space", "Concept 3: Wellness / Studio Space", "None of the above", "None of the above", "Concept 1: Backyard Home Office", "Concept 5: Simplicity"],
  ...
  4: {
    ...
    Q0b: [3.0, 0.8], Q1: [2.8, 0.9], Q2: [2.4, 0.9],
    Q3: ["Guest suite / short-term rental (STR) income", "Guest suite / short-term rental (STR) income", "General storage / premium speed shed", "General storage / premium speed shed", "Guest suite / short-term rental (STR) income", "Home office / remote workspace"],
    Q5_cost: [2.5, 0.8], Q5_hoa: [3.8, 0.7], Q5_permit: [3.5, 0.8],
    Q5_space: [1.6, 0.6], Q5_financing: [1.8, 0.6], Q5_quality: [3.0, 0.8], Q5_resale: [3.4, 0.8],
    Q6: ["The total cost (~$23,000)", "The total cost (~$23,000)", "The total cost (~$23,000)", "HOA restrictions or community rules", "Uncertainty about whether a building permit is required", "Uncertainty about resale value"],
    Q7: [4.2, 0.6],
    ...
    Q14: ["Concept 2: Guest Suite / STR Income", "Concept 2: Guest Suite / STR Income", "Concept 2: Guest Suite / STR Income", "None of the above", "None of the above", "Concept 5: Simplicity"],
  ...
  5: {
    ...
    Q0b: [1.8, 0.7], Q1: [1.6, 0.6], Q2: [1.4, 0.5],
    Q3: ["General storage / premium speed shed", "General storage / premium speed shed", "General storage / premium speed shed", "General storage / premium speed shed", "Creative studio (music, podcast, art)", "Children's playroom"],
    ...
    Q14: ["None of the above", "None of the above", "None of the above", "Concept 5: Simplicity", "Concept 5: Simplicity", "Concept 5: Simplicity"],
